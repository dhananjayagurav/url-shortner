"""End-to-end tests against a running app + real Postgres (docker compose).
No mocking -- Phase 1 is about seeing the whole system work together.
Note: these hit your real dev database, not an isolated test DB -- that's
a known simplification for now."""
